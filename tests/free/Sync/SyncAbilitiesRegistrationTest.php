...
class SyncAbilitiesRegistrationTest extends \WP_UnitTestCase
{
    private const NAMES = [
    ...
    public function test_sync_abilities_have_description_and_category(): void
    {
    ...
    public function test_sync_abilities_deny_subscriber_and_allow_administrator(): void
    {
        $abilities = wp_get_abilities();
