...
// and only near the top of the file: an extra conjunct, or a guard buried under
// hundreds of use statements, both make it report the file as unprotected. The
// test bootstrap defines ABSPATH itself, so the guard needs no escape hatch.
if (! defined('ABSPATH')) {
    exit;
}
