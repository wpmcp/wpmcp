...
class Upload_Svg
{
    ...
    public function handle(array $args): array
    {
        ...
        if (! empty($upload['error'])) {
            throw new \RuntimeException(esc_html('The SVG could not be written to the uploads directory: ' . $upload['error']));
        }
        ...
        if (is_wp_error($media_id)) {
            ...
            throw new \RuntimeException(esc_html('The SVG attachment could not be created: ' . $media_id->get_error_message()));
        }
