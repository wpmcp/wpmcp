    ...
    public function handle(array $args): array
    {
        ...
        if ($in_flight >= $max) {
            ...
            throw new \RuntimeException(
                esc_html("Too many CLI jobs are already in flight ({$in_flight} of a maximum {$max}). Wait for them to finish, cancel them with cancel-cli-job, or raise the wpmcp_cli_job_max_in_flight filter.")
            );
        }
