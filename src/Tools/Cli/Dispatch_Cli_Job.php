    ...
    public function handle(array $args): array
    {
        ...
        if ($in_flight >= $max) {
            ...
            throw new \RuntimeException(
                sprintf('Too many CLI jobs are already in flight (%d of a maximum %d). Wait for them to finish, cancel them with cancel-cli-job, or raise the wpmcp_cli_job_max_in_flight filter.', (int) $in_flight, (int) $max)
            );
        }
